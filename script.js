...
function changeImage(){
    ...
    if($.inArray(number, previousNumbers) == -1)
    {
...
function startTimer(duration, display) {
    ...
    function timer() {
        ...
        if (diff <= 0) {
            ...
            document.getElementById("inputName").disabled = "disabled";
            document.getElementById("skipButton").disabled = "disabled";
...
function pokemonNameTextChanged() {
    var elementInput = document.getElementById("inputName");
    var pokemonInputText = elementInput.value.toLowerCase();
    var pokemonName = pokemon[number - 1].toLowerCase();
